...
type ActionGet struct {
	...
	SFTPPort              string           `json:"sftp_port"`
	SFTPUser              string           `json:"sftp_user"`
	SFTPIdentityType      api.FieldOptions `json:"sftp_identity_type"`
	SFTPRemotePath        string           `json:"sftp_remote_path"`
	SFTPChgrp             string           `json:"sftp_chgrp"`
	SFTPChmod             string           `json:"sftp_chmod"`
	SFTPChmodKey          string           `json:"sftp_chmod_key"`
	...
	RemoteSSHPort         string           `json:"remote_ssh_port"`
	RemoteSSHUser         string           `json:"remote_ssh_user"`
	RemoteSSHIdentityType api.FieldOptions `json:"remote_ssh_identity_type"`
	RemoteSSHCommand      string           `json:"remote_ssh_command"`
	Configd               api.FieldOptions `json:"configd"`
	ConfigdGenericCommand api.FieldOptions `json:"configd_generic_command"`
	SynologyDSMHostname   string           `json:"acme_synology_dsm_hostname"`
	SynologyDSMPort       string           `json:"acme_synology_dsm_port"`
	SynologyDSMScheme     api.FieldOptions `json:"acme_synology_dsm_scheme"`
	SynologyDSMUsername   string           `json:"acme_synology_dsm_username"`
	SynologyDSMPassword   string           `json:"acme_synology_dsm_password"`
	SynologyDSMCreate     string           `json:"acme_synology_dsm_create"`
	SynologyDSMDeviceID   string           `json:"acme_synology_dsm_deviceid"`
	...
	TrueNASAPIKey         string           `json:"acme_truenas_apikey"`
	TrueNASHostname       string           `json:"acme_truenas_hostname"`
	TrueNASScheme         api.FieldOptions `json:"acme_truenas_scheme"`
	UnifiKeystore         string           `json:"acme_unifi_keystore"`
	VaultURL              string           `json:"acme_vault_url"`
	VaultPrefix           string           `json:"acme_vault_prefix"`
	VaultToken            string           `json:"acme_vault_token"`
...
type CertificateGet struct {
	...
	Name             string           `json:"name"`
	Description      string           `json:"description"`
	AltNames         api.FieldOptions `json:"altNames"`
	Account          api.FieldOptions `json:"account"`
	ValidationMethod api.FieldOptions `json:"validationMethod"`
	KeyLength        api.FieldOptions `json:"keyLength"`
	OCSP             string           `json:"ocsp"`
	RestartActions   api.FieldOptions `json:"restartActions"`
	AutoRenewal      string           `json:"autoRenewal"`
	RenewInterval    string           `json:"renewInterval"`
	AliasMode        api.FieldOptions `json:"aliasmode"`
	DomainAlias      string           `json:"domainalias"`
	ChallengeAlias   string           `json:"challengealias"`
...
type Settings struct {
	Enabled            string           `json:"enabled"`
	AutoRenewal        string           `json:"autoRenewal"`
	UpdateCron         api.FieldOptions `json:"UpdateCron"`
	Environment        api.FieldOptions `json:"environment"`
	...
	HAProxyAclRef      api.FieldOptions `json:"haproxyAclRef"`
	HAProxyActionRef   api.FieldOptions `json:"haproxyActionRef"`
	HAProxyServerRef   api.FieldOptions `json:"haproxyServerRef"`
	HAProxyBackendRef  api.FieldOptions `json:"haproxyBackendRef"`
	LogLevel           api.FieldOptions `json:"logLevel"`
...
type ValidationGet struct {
	...
	Name                        string           `json:"name"`
	Description                 string           `json:"description"`
	Method                      api.FieldOptions `json:"method"`
	HTTPService                 api.FieldOptions `json:"http_service"`
	HTTPOpnAutodiscovery        string           `json:"http_opn_autodiscovery"`
	HTTPOpnInterface            api.FieldOptions `json:"http_opn_interface"`
	HTTPOpnIPAddresses          []string         `json:"http_opn_ipaddresses"`
	HTTPHAProxyInject           string           `json:"http_haproxyInject"`
	HTTPHAProxyFrontends        []string         `json:"http_haproxyFrontends"`
	TLSALPNService              api.FieldOptions `json:"tlsalpn_service"`
	TLSALPNAcmeAutodiscovery    string           `json:"tlsalpn_acme_autodiscovery"`
	TLSALPNAcmeInterface        api.FieldOptions `json:"tlsalpn_acme_interface"`
	TLSALPNAcmeIPAddresses      []string         `json:"tlsalpn_acme_ipaddresses"`
	DNSService                  api.FieldOptions `json:"dns_service"`
	DNSSleep                    string           `json:"dns_sleep"`
	DNSActive24Token            string           `json:"dns_active24_token"`
	DNSAdKey                    string           `json:"dns_ad_key"`
	DNSAliKey                   string           `json:"dns_ali_key"`
	...
	DNSKnotServer               string           `json:"dns_knot_server"`
	DNSKnotKey                  string           `json:"dns_knot_key"`
	DNSLexiconProvider          api.FieldOptions `json:"dns_lexicon_provider"`
	DNSLexiconUser              string           `json:"dns_lexicon_user"`
	DNSLexiconToken             string           `json:"dns_lexicon_token"`
	DNSLimacityAPIKey           string           `json:"dns_limacity_apikey"`
	DNSLinodeKey                string           `json:"dns_linode_key"`
	...
	DNSKasLogin                 string           `json:"dns_kas_login"`
	DNSKasAuthData              string           `json:"dns_kas_authdata"`
	DNSKasAuthType              api.FieldOptions `json:"dns_kas_authtype"`
	DNSDeSECToken               string           `json:"dns_desec_token"`
	DNSDeSECName                string           `json:"dns_desec_name"`
	DNSInfomaniakToken          string           `json:"dns_infomaniak_token"`
	DNSZoneUsername             string           `json:"dns_zone_username"`
